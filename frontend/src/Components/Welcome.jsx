  ...
  return (
    ...
    <div className="container-fluid flex flex-wrap flex-col h-screen">
      ...
      <div className="order-2 w-full p-4 md:w-1/2 flex-1 h-full flex flex-col justify-start items-start md:justify-center md:items-start">
       <h1 className="self-start text-white text-7xl font-bold mb-24">Happening now</h1>
       <h2 className="text-white text-2xl font-bold mb-4">Join today.</h2>
       <button className="bg-twitter-blue hover:bg-twitter-blue-hover text-white font-bold px-4 py-2 rounded-full w-3/4 md:w-1/2 mb-4">Create account</button>
       <hr className="w-3/4 md:w-1/2 text-white mb-8"></hr>
       <p className="text-white text-md font-bold mb-4">Already have an account?</p>
